...
from hsr_gym.utils.transformations import angle_diff, euler_to_quat, quat_to_euler, add_angles, pose_diff, quat_diff
from hsr_gym.utils.ros_utils import Publisher, Listener, create_twist_command
...
class HSR:
    ...
    def gripper_state(self):
        ...
        # print ("Gripper observation time: ", time.time() - start_time)
    ...
    def get_delta_pose(self):
        ...
        # print("Base observation time: ", time.time() - start_time)
    ...
    def step(self, action):
        ...
        if self.arm_enabled:
            ...
            if abs(gripper_act - self.gripper_state) > 0.2:
                ...
                # print ("Gripper time: ", time.time() - start_time)
