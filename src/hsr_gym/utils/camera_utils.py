...
from hsr_gym.utils.ros_utils import Listener
...
class RGBCamera:
    ...
    def __init__(self, img_topic, input_message_type=Image, camera_info_topic=None,
                 img_post_proc_func=None, *args, **kwargs) -> None:
